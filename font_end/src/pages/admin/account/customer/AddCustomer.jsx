        ...
        <Row gutter={24}>
          ...
          <Col span={16}>
            ...
            <Row gutter={10}>
              ...
              <Col span={12}>
              <Form.Item label={"CCCD/CMT"} name={"cccd"} rules={[{ required: true, message: "Cccd không được để trống!", },{ pattern: '^([0-9]{9}|[0-9]{12})$', message: "Mã định danh phải có 9 hoặc 12 kí tự!" }]}>
