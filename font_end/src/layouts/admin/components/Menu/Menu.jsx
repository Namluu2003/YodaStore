...
const Sidebar = () => {
  ...
  return (
    <Menu mode="inline" className="h-100" theme={sessionStorage.getItem('theme') === "true" ? 'light' : 'dark'}>
      <Link className="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
        <img src={sessionStorage.getItem('theme') === "true" ? `/logo.jpg` : `/logo.jpg`} alt="" width="60%" onClick={() => changeTheme()}/>
      </Link>
