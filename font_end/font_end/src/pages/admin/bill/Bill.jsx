      ...
      <div class="">
        ...
        <div className="table-responsive">
          <table className="table table-striped">
            <thead className="">
              <tr>
                <th className="bg-primary text-white py-3 px-4">#</th>
                <th className="bg-primary text-white py-3 px-4">Mã HĐ</th>
                <th className="bg-primary text-white py-3 px-4">Tổng tiền</th>
                <th className="bg-primary text-white py-3 px-4">Ngày Tạo</th>
                <th className="bg-primary text-white py-3 px-4">Khách hàng</th>
                <th className="bg-primary text-white py-3 px-4">Số điện thoại</th>
                <th className="bg-primary text-white py-3 px-4">Loại đơn hàng</th>
                <th className="bg-primary text-white py-3 px-4">Trạng thái</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
